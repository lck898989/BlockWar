(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/Game1/PersonsGame1Main.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5bcabg/v4dGwb1mqs0cTbpF', 'PersonsGame1Main', __filename);
// Scripts/Game1/PersonsGame1Main.js
...
cc.Class((_cc$Class = {
    ...
    pauseFunction: function pauseFunction() {
        //显示暂停菜单
    ...
    onLoad: function onLoad() {
        ...
        if (cc.sys.isNative) {
            ...
            this.isOutDown = true;
            //当手指落在滑动节点上时
            this.nodeMove.on(cc.Node.EventType.TOUCH_START, function (event) {}, this);
            //当手指在滑动节点上移动时
            this.nodeMove.on(cc.Node.EventType.TOUCH_MOVE, function (event) {
                self.isOutSlide = false;
                self.positionTouchX = event.getLocationX();
     ...
     */
    //初始化敌人地图针对游戏2和游戏4
    initRivalMap: function initRivalMap(up, lr, back, row, col) {
        //找到对手游戏
    ...
    */
    ...
    //判断方块颜色
    IsColor: function IsColor(stringColor, nColor) {
...
}, _defineProperty(_cc$Class, "GetTouchLine", function GetTouchLine(worldPosition) {
    //将触摸点的横坐标转化为本地坐标
    var nodePosition = worldPosition - (this.nodeMove.getPositionX() + this.nodeCanvas.getPositionX());
    if (nodePosition > 0) {
        var nWidth1 = Math.floor(nodePosition / (this.nodeMove.width / 20));
...
}), _defineProperty(_cc$Class, "GetBlockLine", function GetBlockLine() {
    var nLine = (this.nodeBlock.getPositionX() - this.nodeUserParent.getPositionX()) / Global.nWidth + 1;
    return nLine;
}), _defineProperty(_cc$Class, "SendMsgDown", function SendMsgDown() {
    //获取节点子节点数组
    var blockChild = this.nodeBlock.getChildren();
    //  //判断俄罗斯方块是否结束地面
...
}), _defineProperty(_cc$Class, "playAudio", function playAudio(audioSource) {
    cc.audioEngine.play(audioSource, false, 1);
}), _defineProperty(_cc$Class, "DownQuick", function DownQuick() {
    if (this.nodeBlock.getComponent("OperateBlock").isCollision == false) {
        this.playAudio(this.clickAudio);
        this.nodeBlock.getComponent("OperateBlock").fDownTime = Global.nTimeInteval;
    }
}), _defineProperty(_cc$Class, "GetBoxNode", function GetBoxNode(childBox) {
    //获取子块在地板附体下的行列
    ...
    return cc.p(x, y);
}), _defineProperty(_cc$Class, "PunishUp", function PunishUp(nDisappearAll) {
    this.arrayChangeNode = [];
    console.log("in punishUp nDisappearAll is ", nDisappearAll);
    for (var i = 19; i >= 0; i--) {
        inner: for (var j = 0; j <= 9; j++) {
...
}), _defineProperty(_cc$Class, "BoxDown", function BoxDown(nMaxDisappea, nDisappearAll) {
    //存取消行行行列
    ...
    // this.isMoveState=true;
    this.isDisppearState = true;
}), _defineProperty(_cc$Class, "ShowScore", function ShowScore(nDissppearRow1, nodeScore) {
...
}), _defineProperty(_cc$Class, "MoveRight", function MoveRight(nLine, nLine1) {
    if (nLine == nLine1) {
        return;
    }
    //存取俄罗斯方块的行数
...
}), _defineProperty(_cc$Class, "MoveLeft", function MoveLeft(nLine, nLine1) {
    if (nLine == nLine1) {
        return;
    }
    //存取俄罗斯方块的行数
...
}), _defineProperty(_cc$Class, "DisappearBox", function DisappearBox() {
...
}), _defineProperty(_cc$Class, "share", function share() {
    if (CC_WECHATGAME) {
        console.log("首页share");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=PersonsGame1Main.js.map
