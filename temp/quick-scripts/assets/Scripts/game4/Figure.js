(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/game4/Figure.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bc5b2ScYUJBMKdB98R2fZs7', 'Figure', __filename);
// Scripts/game4/Figure.js
...
cc.Class((_cc$Class = {
     ...
     */
    quickDown: function quickDown(row, col, backGroundArr, map, isNetWork) {
        var jsonMsgToServer = {
            tag1: 9,
            score: "",
            type: "",
    ...
    //消除下落操作
    afterRemoveDown: function afterRemoveDown(map, backGroundArr, isNetWork) {
        var jsonMsgToServer = {
            tag1: 9,
            score: "",
            type: "",
        ...
        var beforeRow = this.row;
        var beforeCol = this.col;
